...
func main() {
	...
	checks := []error{
		pdf.SetMetadata(minpdf.Metadata{Title: "minpdf Cross-Language Showcase", Author: "Actile", Subject: "Identical feature showcase for every binding", Keywords: "minpdf,pdf,showcase", Creator: "minpdf", CreationDate: "D:20260101000000Z"}),
	...
	if err = pdf.Save("examples/results/minpdf-showcase-go.pdf"); err != nil {
		log.Fatal(err)
	}
	log.Println("wrote examples/results/minpdf-showcase-go.pdf")
}
